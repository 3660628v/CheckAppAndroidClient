...
import com.android.task.main.function.GetInfoTask;
import com.android.task.main.function.IdShow;
...
public class LoginActivity extends Activity {
				...
				.setOnEditorActionListener(new TextView.OnEditorActionListener() {
					public boolean onEditorAction(TextView textView, int id,
						...
						if (id == R.id.login || id == EditorInfo.IME_NULL) {
							attemptLogin(mSavePass.isChecked());
							return true;
						}
						return false;
					}
	 ...
	 */
	public void attemptLogin(boolean saveFlag) {
		if (mAuthTask != null) {
			return;
		}
		...
		if (cancel) {
			...
			mAuthTask.doLogin(mEmail, mPassword, mUrlConf.getHost(), mEquipmentId.getId(), 0);
		}
	}
	...
	private class UserLoginTask extends GetInfoTask {
		...
		public void doLogin(String name, String pass, String host, String ua, int type) {
			_type = type;
			_useragent = ua;
			...
			String url =  "http://"+host+"/api/v1/sessions";
			execute(url, _useragent, "post");
		}
		...
		protected void onPostExecPost(Boolean succ) {
			...
			if ( succ ) {
				...
				try {
					...
					Intent yunjianIntent = new Intent(LoginActivity.this,WebMainActivity.class);
